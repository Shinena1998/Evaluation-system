...
/**
 * Servlet implementation class XieShangJiPingJiao
 */
@WebServlet("/XieShangJiPingJiao")
public class XieShangJiPingJiao extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public XieShangJiPingJiao() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			String sql1 = "insert into ShangJiPingJiaoGongDeFenBiao values(?,?,?,?,?,?)";
			for (int i = 0; i < 3; i++) {
			...
			if(count > 0) {
				String sql2 = "update ShangJiYuJiaoGongDuiYingBiao set ShiFouYiPingJiao=1 where XueNian=? and XueQi=? and ShangJiJiaoGongHao=? and BeiPingJiaoGongHao=?";
